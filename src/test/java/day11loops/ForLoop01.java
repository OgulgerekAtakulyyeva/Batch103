...
public class ForLoop01 {
    public static void main(String[] args) {
        ...
        //      System.out.println(sum); loop'un icine yazilirsa her bir loop icin "sum"'un hangi degerleri aldigini yazdirir

        System.out.println(sum);


        //Example2 : 6 den 3 a kadar tamsayilarin carpimini bulan kodu yaziniz
        ...
        //           "Kaba" == "abaK"
        String str = "Kaba";
        //Concatinetion yapacaksaniz "" kullanin
        String ters = "";
